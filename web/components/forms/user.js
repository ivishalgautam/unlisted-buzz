...
import { Calendar } from "../calendar-eldora";
import Spinner from "../spinner";
import { fetchUser } from "@/service/users";
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="w-full py-6">
      ...
      <div className="space-y-4">
        <div className="divide-y">
          <div className="py-4">
            <div className="space-y-4">
              <div className="flex items-center justify-center gap-4 rounded-lg border border-dashed border-gray-300 p-8 w-max">
                {image ? (
