...
import { deleteSector, fetchSectors } from "@/server/sector";
...
export default function Listing() {
  ...
  const { data, isLoading, isFetching, isError, error } = useQuery({
    queryFn: () => fetchSectors(searchParamStr),
    queryKey: ["sectors", searchParamStr],
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries(["sectors", searchParamStr]);
